...
export default function NavBar() {
    return (
        <div className='fixed w-full z-50 md:pt-10 pt-0 backdrop-blur-md'>
            <div className='container mx-auto'>
                <div className='flex justify-between border-b-[0.05px] border-green-500 border-opacity-20 md::p-0 p-6 pt-0 pb-4'>
